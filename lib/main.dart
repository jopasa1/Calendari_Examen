...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Examen Calendario',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      routes: {
        '/settings': (context) => EditarEsdevenimentForm(),
        '/calendari/view' : (context) => MyHomePage(title: "Calendari Jordi Pascual Sanchez"),
      },
      home: MyHomePage(
        title: "Calendari de Jordi Pascual Sanchez",
      ),
    );
  }
}
